        ...
        <div>
            <div className="carousel w-full h-[600px]">
                ...
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8d2Vic2l0ZSUyMGJhbm5lciUyMGJhZCUyMHByb2R1Y3QlMjBpbWd8ZW58MHx8MHx8fDA%3D" className="w-full rounded-xl" />
                    <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                        <div className='text-white lg:space-y-7 lg:pl-12 lg:w-1/2'>
                            <h2 className='lg:text-6xl text-4xl font-bold'>There are Most categories product web search queries</h2>
